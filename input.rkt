...
(define BOX (textbox 500 50 "blue" "" (posn 300 50) #f))
...
(define (set-active tbox)
  (textbox (textbox-width tbox) (textbox-height tbox) (active-color (textbox-color tbox)) (textbox-location tbox) #true))

;; set-inactive: textbox -> textbox
;; Purpose: Sets a textbox to inactive
(define (set-inactive tbox)
  (textbox (textbox-width tbox) (textbox-height tbox) (inactive-color (textbox-color tbox)) (textbox-location tbox) #false))
